---
name: "source-command-database-migration-and-application-update"
description: "Workflow command scaffold for database-migration-and-application-update in PROMPT-APP."
---

# source-command-database-migration-and-application-update

Use this skill when the user asks to run the migrated source command `database-migration-and-application-update`.
