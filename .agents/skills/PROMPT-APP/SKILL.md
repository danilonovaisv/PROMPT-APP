...
1. Add or update files in `.Codex/commands/` (e.g., `database-migration-and-application-update.md`, `feature-development.md`).
2. Add or update `.Codex/skills/PROMPT-APP/SKILL.md`.
3. Add or update `.Codex/ecc-tools.json`.
4. Add or update `.Codex/identity.json`.
5. Add or update `.Codex/homunculus/instincts/inherited/PROMPT-APP-instincts.yaml`.
