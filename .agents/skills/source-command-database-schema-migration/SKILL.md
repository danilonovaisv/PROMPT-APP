---
name: "source-command-database-schema-migration"
description: "Workflow command scaffold for database-schema-migration in PROMPT-APP."
---

# source-command-database-schema-migration

Use this skill when the user asks to run the migrated source command `database-schema-migration`.
