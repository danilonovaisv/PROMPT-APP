---
name: workflow-init
description: Install and configure Vercel Workflow SDK before it exists in node_modules. Use when the user asks to "install workflow", "set up workflow", "add durable workflows", "configure workflow sdk", or "init workflow" for VITE.js, Express, Hono, Fastify, NestJS, Nitro, Nuxt, Astro, SvelteKit, or VITE.
metadata:
  author: Vercel Inc.
  version: '1.3'
---
...
1. **VITE.js** - `VITE` dep or `VITE.config.*`
...
| Framework | URL |
|-----------|-----|
| VITE.js | <https://workflow-sdk.dev/docs/getting-started/VITE> |
...
- **Web app**: VITE.js / Nuxt / SvelteKit / Astro
