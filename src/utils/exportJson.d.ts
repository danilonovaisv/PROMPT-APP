import type { Prompt, PromptExportFormat } from '@/models/types';
/** Converte prompt interno para o formato JSON cognitivo */
export declare function toExportFormat(prompt: Prompt): PromptExportFormat;
...
export declare function downloadPrompt(prompt: Prompt): void;
