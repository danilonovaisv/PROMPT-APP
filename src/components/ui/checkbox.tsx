...
export const Checkbox = ({ checked = false, onChange, disabled = false, indeterminate = false, children, className }: CheckboxProps) => {
  return (
    <div
      className={`flex items-center cursor-pointer text-[13px] font-sans group ${disabled ? "text-gray-500" : "text-gray-1000"} ${className || ""}`}
